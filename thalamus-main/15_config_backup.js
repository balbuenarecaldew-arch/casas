...
window.exportJSON=function(){
  const data=JSON.stringify({obras,gastos,certificados,actividades,retiros,gestorPagos,ayudaSocialPagos,contratistaPagos,cfg},null,2);
...
function buildBackupData(){
  return{
    ...
    obras,gastos,certificados,actividades,retiros,gestorPagos,ayudaSocialPagos,contratistaPagos,cfg
  };
}
...
window.restoreFromFirebase=async function(id){
  ...
  try{
    ...
    try{
      ...
      // Retiros, actividades, gestor y ayuda social
      await fbSet('actividades/list',{lista:actividades});
